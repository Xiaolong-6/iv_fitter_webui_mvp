...
- **Start here:** minimal welcome page with a concise workflow overview and compact current project state.
...
- Simplified the Start here page into a large title, short software description, and four-step workflow.
- Removed duplicated Quick actions from the welcome page.
- Added icons to sidebar navigation tabs.
- Added Data-page Plot review by reusing the existing PlotWorkspace component.
