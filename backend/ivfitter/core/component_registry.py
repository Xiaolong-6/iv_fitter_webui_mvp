...
def component_registry() -> list[FunctionDefinition]:
    ...
    return [
        ...
        FunctionDefinition(
            ...
            help_text="Adds a diode-like voltage drop in the main series path, useful for injection/contact-barrier-like behavior. Polarity controls which current direction activates the barrier drop.",
        ),
        FunctionDefinition(
            ...
            canonical_equation="expression(I or Vi, params)",
            available_forms=["current_branch", "voltage_drop", "conductance_modifier"],
            default_form="current_branch",
            allowed_placements=["parallel_current_branch", "junction_current_branch", "series_voltage_drop", "series_conductance_modifier"],
            default_placement="parallel_current_branch",
            allowed_polarities=["forward", "reverse", "symmetric"],
            default_polarity="forward",
            parameters=[
            ...
            equation_template="expression(I or Vi, params)",
