...
export const MB3_BUILT_IN_PRESETS: Mb3SavedPreset[] = [
  {
    ...
    graph: {
      ...
      wires: [
        ...
        { id: "w2", from: { kind: "component", id: "Rs", port: "n" }, to: { kind: "component", id: "D1", port: "p" } },
        { id: "w3", from: { kind: "component", id: "Rs", port: "n" }, to: { kind: "component", id: "Rsh", port: "p" } },
        { id: "w4", from: { kind: "component", id: "D1", port: "n" }, to: { kind: "node", id: "GND" } },
        { id: "w5", from: { kind: "component", id: "Rsh", port: "n" }, to: { kind: "node", id: "GND" } },
      ],
    },
  },
  {
    ...
    graph: {
      ...
      wires: [
        { id: "w1", from: { kind: "node", id: "V" }, to: { kind: "component", id: "Rs", port: "p" } },
        { id: "w2", from: { kind: "component", id: "Rs", port: "n" }, to: { kind: "component", id: "D1", port: "p" } },
        { id: "w3", from: { kind: "component", id: "Rs", port: "n" }, to: { kind: "component", id: "D2", port: "p" } },
        { id: "w4", from: { kind: "component", id: "Rs", port: "n" }, to: { kind: "component", id: "Rsh", port: "p" } },
        { id: "w5", from: { kind: "component", id: "D1", port: "n" }, to: { kind: "node", id: "GND" } },
        { id: "w6", from: { kind: "component", id: "D2", port: "n" }, to: { kind: "node", id: "GND" } },
        { id: "w7", from: { kind: "component", id: "Rsh", port: "n" }, to: { kind: "node", id: "GND" } },
      ],
    },
  },
];
