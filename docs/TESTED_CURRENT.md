# Tested current package — v1.4.14

Scope: v1.4.14 plot trace selector, plus retained HappyMeasure import/sample-data regression coverage.
...
## v1.4.14 sample-data verification
...
## v1.4.14 plot selector verification
...
## v1.4.14 model-structure verification
...
## v1.4.14 manual-alignment verification
...
## v1.4.14 Model Builder polish verification
