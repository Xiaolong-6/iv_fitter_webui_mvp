...
- `docs/USER_MANUAL.md` — full user manual for import, Model Builder, fitting, validation, and reporting.
...
- `docs/ARCHITECTURE.md` - current runtime split and Model Builder architecture.
